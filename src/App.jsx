...
export default function GatewaySession() {
  ...
  return (
    <div style={{ ...(desktop?{height:"100vh",overflow:"hidden"}:{minHeight:"100vh"}),
      ...
      <div style={{ width:"100%",maxWidth:desktop?1200:560,...(desktop?{display:"flex",flexDirection:"column"}:{}) }}>
            ...
            {desktop ? (
              <div style={{ display:"flex",gap:16,width:"100%",marginTop:4 }}>
                ...
                <div style={{ flex:1 }}>
                  <div style={{ display:"flex",gap:6,flexWrap:"wrap" }}>
                    {Object.keys(PRESETS).map(name=>(
                      <button key={name} onClick={()=>loadPreset(name)} disabled={isPlaying}
                        ...
                        color:preset===name?"#5DC863":"rgba(200,190,230,0.7)",borderRadius:8,padding:"8px 14px",
                  ...
                  {preset && <p style={{ fontSize:11,color:"rgba(33,144,140,0.7)",
        ...
        <div style={{ marginTop:desktop?8:20,display:"flex",flexDirection:"column",gap:8,
          ...
          <div style={{ display:"flex",justifyContent:"space-between",alignItems:"center" }}>
            ...
            <button onClick={addLayer} disabled={layers.length>=6||isPlaying} style={{
              ...
              color:"rgba(33,144,140,0.8)",borderRadius:6,padding:desktop?"4px 10px":"8px 14px",fontSize:11,
        ...
        <p style={{ textAlign:"center",fontSize:10,color:"rgba(33,144,140,0.5)",marginTop:desktop?8:28,
          fontFamily:"'JetBrains Mono',monospace" }}>
